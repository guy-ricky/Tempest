...
const SITEMAP = [
  ...
  {
    title: "Products",
    links: ["Dinner Sets", "Organizers", "Home Decor", "Cooking Pots"],
  },
];
...
const Footer = () => {
  return (
    <footer className="relative w-full bg-[#232f3e]">
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Blessed Home Accessories</a>. All
            Rights Reserved.
          </Typography>
